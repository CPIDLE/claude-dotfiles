...
4. 選擇以下檔案：
   ...
   ```
   C:\Users\benth\Documents\Project\.doc\.claude\skills\md-to-deck\SKILL.md
   ```

5. 確認 "My skills" 列表出現 **md-to-deck**
...
- 如果 Desktop 只載入 SKILL.md 而**沒有複製 assets 資料夾**，需要手動將整個 `md-to-deck/` 目錄複製到：
  ```
  %APPDATA%\Claude\local-agent-mode-sessions\skills-plugin\...\skills\md-to-deck\
  ```
